...
import { volunteerProfile, stats } from '@/components/utils/dummyData';

export function VolunteerDashboard() {
  return (
    <div>
      {/* Hero Banner */}
      <div className="relative bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl mb-8 p-8 flex items-center shadow-lg overflow-hidden">
        <div>
        ...
        <img
          ...
          alt="Volunteer"
          className="ml-auto rounded-full shadow-lg w-20 h-20 border-4 border-white hidden md:block"
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {stats.map((stat) => (
          <div 
            key={stat.label}
            className={`flex items-center gap-4 p-6 rounded-xl border shadow hover:shadow-lg transition-all duration-200 ${stat.color} ${stat.border} hover:scale-105`}
          >

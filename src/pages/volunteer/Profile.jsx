...
//   // **NEW: Handle default password detection and tab selection**
//   useEffect(() => {
//     // Check URL params for tab first
...
//       // Force user to security tab
//       setActiveTab("security");
      
//       // Show a notification that password change is required
//       setTimeout(() => {
//         if (toast) {
//           toast({
...
//       // Remove the flag so it doesn't show again after password is changed
//       localStorage.removeItem("requirePasswordChange");
//     } else if (tabParam && ['profile', 'security'].includes(tabParam)) {
//       // Set tab from URL if no password change required
...
//       setPasswordChangeStatus({ type: "error", message: t("profile.errors.passwordTooShort") });
//       return;
//     }
...
const getLevel = (hours, t) => {
  ...
  if (hours >= 200 && hours < 420)
    return { label: t("profile.badges.Humanitarian"), icon: <Globe size={36} /> };
  return { label: t("profile.badges.Lord of the deeds"), icon: <Award size={36} />}; // Using Award icon as placeholder
};

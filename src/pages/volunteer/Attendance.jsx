            ...
            <div className="sidebar">
              ...
              <div className="sidebar-card">
                ...
                <div className="sidebar-details">
                  ...
                  <div className="sidebar-detail-item">
                    <p className="detail-label">Coordinator</p>
                    <p className="detail-value">{todaySession.coordinator}</p>
                  </div>
                  <div className="sidebar-detail-item">
                    <p className="detail-label">Duration</p>
                    <p className="detail-value">1.5 hours</p>
                  </div>
                </div>
              </div>
                ...
                <div className="upcoming-sessions">
                  {upcomingSessions.map((session) => (
                    <div key={session.id} className="upcoming-session-item">
                      <p className="upcoming-session-title">{session.title}</p>
                      <p className="upcoming-session-meta">
